...
class _RdvScreenState extends State<RdvScreen> with SingleTickerProviderStateMixin {
  ...
  List<DisponibiliteResponse> _disponibilites = [];
  ...
  String? _selectedDisponibiliteId;
  ...
  Future<void> _loadRdvs() async {
    try {
      ...
      // Charger disponibilités si on est en mode création
      if (_isCreatingMode && widget.conseillerId != null) {
        _disponibilites = await _api.getDisponibilitesConseiller(widget.conseillerId!);
      }
  ...
  Future<void> _submitRdv() async {
    ...
    try {
      ...
      final request = RendezVousRequest(
        ...
        notes: _commentaireController.text.isNotEmpty ? _commentaireController.text : null,
      );
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text('Garder', style: TextStyle(color: AppColors.primary)),
          ),
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color:
                              _selectedDate != null ? AppColors.primary : AppColors.textLight,
                          size: 20,
                        ),
                        const SizedBox(width: 12),
                        Text(
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color:
                              _selectedTime != null ? AppColors.primary : AppColors.textLight,
                          size: 20,
                        ),
                        const SizedBox(width: 12),
                        Text(
                ...
                // Objet
                Text('Objet du rendez-vous', style: AppTextStyles.label),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _objetController,
                  decoration: InputDecoration(
                    hintText: 'Ex: Choix d\'orientation, Bilan scolaire...',
                    prefixIcon: const Icon(Icons.title_rounded, color: AppColors.textLight),
                  ),
                ...
                // Commentaire
                Text('Commentaire (optionnel)', style: AppTextStyles.label),
                const SizedBox(height: 8),
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.note_rounded, color: AppColors.textLight),
  ...
  Widget _buildRdvsList() {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.event_busy_rounded, size: 64, color: AppColors.primary),
            ),
            const SizedBox(height: 24),
            Text(
              'Aucun rendez-vous',
            ...
            if (widget.conseillerId == null)
              PrimaryButton(
                ...
                onPressed: () {
                  // TODO: Navigator vers liste des conseillers
                },
    ...
    // Grouper par statut
    final upcoming = _rdvs.where((r) => r.statut.toLowerCase() == 'planifie').toList();
    final past = _rdvs.where((r) => r.statut.toLowerCase() != 'planifie').toList();
