          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Matière', style: AppTextStyles.label),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _matiereController,
                  decoration: InputDecoration(
                    hintText: 'Ex: Mathématiques',
                    prefixIcon: const Icon(Icons.book_rounded, color: AppColors.textLight),
                  ),
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Note /20', style: AppTextStyles.label),
                          const SizedBox(height: 8),
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: '15.5',
                              prefixText: '',
                              prefixIcon: const Icon(Icons.star_rounded, color: AppColors.accent),
                            ),
                            validator: (v) {
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Coefficient', style: AppTextStyles.label),
                          const SizedBox(height: 8),
                          TextFormField(
                ...
                const SizedBox(height: 20),
                Text('Trimestre (optionnel)', style: AppTextStyles.label),
                const SizedBox(height: 8),
                TextFormField(
                  controller: _trimestreController,
                  decoration: InputDecoration(
                    hintText: 'T1, T2, T3 ou S1, S2',
                    prefixIcon: const Icon(Icons.calendar_today_rounded, color: AppColors.textLight),
                  ),
                ),
    ...
    if (_eleveId == null) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.person_outline_rounded, size: 80, color: AppColors.textLight),
            const SizedBox(height: 24),
            Text(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.edit_note_rounded, size: 64, color: AppColors.primary),
            ),
            const SizedBox(height: 24),
            Text(
              'Aucune note saisie',
