...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  final List<_RoleOption> _roles = [
    _RoleOption(role: UserRole.collegien, label: 'Collégien(ne)', icon: Icons.school_outlined),
    _RoleOption(role: UserRole.lyceen, label: 'Lycéen(ne)', icon: Icons.menu_book_outlined),
    _RoleOption(role: UserRole.etudiant, label: 'Étudiant(e)', icon: Icons.account_balance_outlined),
    _RoleOption(role: UserRole.parent, label: 'Parent', icon: Icons.people_outline_rounded),
    _RoleOption(role: UserRole.reconversion, label: 'En reconversion', icon: Icons.work_outline_rounded),
    _RoleOption(role: UserRole.decrocheur, label: 'Jeune décrocheur', icon: Icons.favorite_border_rounded),
  ];
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Je suis...', style: AppTextStyles.label),
                    ...
                    if (_showClassSelector) ...[
                      const SizedBox(height: 24),
                      Text('Quelle classe ?', style: AppTextStyles.label),
                      const SizedBox(height: 8),
                      Container(
                    ...
                    const SizedBox(height: 24),
                    Text('Ville de résidence', style: AppTextStyles.label),
                    const SizedBox(height: 8),
                    TextFormField(
