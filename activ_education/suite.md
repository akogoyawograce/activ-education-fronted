...
✅ lib/screens/home/faq_screen.dart
...
⚠️ PAS ENCORE D'AUTH LOGIN/JWT côté backend (authentification temporaire par trackingId)
...
ÉCRANS À FINALISER (implémentation logique manquante) :
- lib/screens/messages/messages_list_screen.dart   → gestion des conversations
- lib/screens/messages/chat_screen.dart            → envoi/réception en temps réel
- lib/screens/messages/rdv_screen.dart             → prise de rendez‑vous, lien visio
- lib/screens/home/notifications_screen.dart       → suppression d’API quand disponible
- lib/screens/explorer/fiche_detail_screen.dart    → lecteur vidéo / YouTube, navigation vers Messages
- lib/screens/diagnostic/resultats_screen.dart     → navigation vers détail de la filière
- lib/screens/auth/login_screen.dart               → Google Sign‑In
- lib/screens/auth/otp_screen.dart                 → appel API resend, connexion au vrai endpoint auth

PROCHAINS ÉCRANS À CRÉER :
- lib/screens/diagnostic/quiz_screen.dart          → interface de passation du quiz (manquant)
